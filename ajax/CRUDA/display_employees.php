			 	...
			 	<table border=1 id="employee_data">
					...
					$i= 1;
					  while($row = $employee_result->fetch_assoc()) {
						  ...
						  echo "<tr><td>$i</td><td>".$row["Name"]."</td><td>".$row["Phone"] ."</td><td>". $row["Address"]."</td><td><a href=edit.php?id=".$row["Id"].">Edit</a></td><td><input type=button class=row value=delete id =".$row["Id"]."> </td> </tr>";
						  $i++;
					  }
